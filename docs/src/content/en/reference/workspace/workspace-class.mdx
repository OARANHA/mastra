...
{
name: "backgroundProcesses.abortSignal",
type: "AbortSignal | null | false",
description: "Abort signal for background processes. undefined (default) uses the agent's signal. null or false disables abort — processes persist after agent shutdown.",
isOptional: true,
},
]}
/>

See [Background process callbacks](/docs/workspace/processes#background-process-callbacks) for usage examples.
